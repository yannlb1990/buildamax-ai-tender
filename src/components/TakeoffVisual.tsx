            ...
            <div className="flex gap-4 h-full">
              ...
              <div className="flex-1 space-y-4">
                <div className="relative h-[420px] rounded-xl border border-border bg-gradient-to-br from-background via-muted/60 to-background overflow-hidden">
                  <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_25%_20%,rgba(99,102,241,0.12),transparent_25%),radial-gradient(circle_at_80%_10%,rgba(110,231,183,0.12),transparent_30%),radial-gradient(circle_at_30%_80%,rgba(248,113,113,0.12),transparent_28%)]" />

                  <div className="absolute inset-6 rounded-lg border border-dashed border-border/80 bg-white/60 backdrop-blur">
